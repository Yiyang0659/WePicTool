...
**阶段二 AI 分类已完成，阶段三抠图已接入，前端 Canvas 白底卡片合成待实现。**
...
- 深色微信聊天预览页（`pages/preview`）：堆叠卡片、展开/收起、滑动切换，底部模拟微信输入栏。
...
- [API 接口文档](docs/product/api-reference.md)
- [错误处理规范](docs/product/error-handling.md)
